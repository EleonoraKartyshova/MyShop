        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6">
                    ...
                    if (isset($basket)){
                        foreach ($basket as $key => $product):
                            ...
                            <tr  class="basket-row">
                                ...
                                <td><a href="/basket/delete_from_basket/id/<?php echo $key;?>" class="basket-button basket-button-delete" title="Delete product">Delete</a></td>
                            </tr>
                        <?php
                        endforeach;}
                    ?>
                ...
                <form action="/order/place_an_order" method="post">
                    <button type="submit" class="btn btn-primary" title="Place an order">Place an order <span class="glyphicon glyphicon-ok"></button>
                </form>
            </div>
            <div class="col-xs-0 col-sm-1 col-md-2 col-lg-3"></div>
        </div>
